...
export function CredentailsSignIn() {
  ...
  return (
    <form action={formAction} className="space-y-16">
      ...
      <Button size="full" aria-disabled={isPending} className="relative">
        <span className={isPending ? "opacity-0" : "opacity-100"}>Sign In</span>
        ...
        {isPending && (
          ...
          >
            <svg
              aria-hidden="true"
              className="inline size-4 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
              viewBox="0 0 100 101"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
